...
- For Svelte `<Form>` usage, follow the existing pattern of generated controller helpers such as `RssParseController.parseAll.form()` instead of hand-writing action and method attributes.
