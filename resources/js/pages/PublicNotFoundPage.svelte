...
<div class="bg-[radial-gradient(circle_at_top,_rgba(244,114,182,0.18),_transparent_30%),linear-gradient(to_bottom,_#fff7fb,_#eef2ff)] px-4 py-8 dark:bg-[radial-gradient(circle_at_top,_rgba(244,114,182,0.14),_transparent_28%),linear-gradient(to_bottom,_#020617,_#111827)] sm:px-6 lg:px-8">
    <div class="mx-auto max-w-4xl">
        <section class="rounded-[2.25rem] border border-slate-200/80 bg-white/90 p-8 text-center shadow-[0_30px_100px_-60px_rgba(15,23,42,0.45)] backdrop-blur dark:border-white/10 dark:bg-slate-950/80 sm:p-10">
            ...
            <p class="mx-auto mt-4 max-w-2xl text-base leading-7 text-slate-600 dark:text-slate-300">
                Откройте главную ленту, поиск или статистику. Если ссылка вела на статью,
                проверьте, что slug сформирован корректно.
            </p>
