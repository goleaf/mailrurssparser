...
return [
    ...
    */
    ...
    |
    */
    'home_country' => strtoupper((string) env('THREAT_DETECTION_HOME_COUNTRY', 'US')),
    ...
    */
    'dashboard' => [
        'enabled' => env('THREAT_DETECTION_DASHBOARD', true),
        'path' => env('THREAT_DETECTION_DASHBOARD_PATH', 'admin/threat-detection'),
        'middleware' => ['web', 'auth'],
    ],
    ...
    */
    'api' => [
        ...
        'prefix' => env('THREAT_DETECTION_API_PREFIX', 'admin/threat-detection/api'),
        'middleware' => ['web', 'auth'],
    ],
