...
return [
     ...
     */
    'queue_connection_name' => env('MEDIA_QUEUE_CONNECTION', env('QUEUE_CONNECTION', 'failover')),
    ...
    'responsive_images' => [
         ...
         */
        'width_calculator' => App\Support\MediaLibrary\NewsPortalWidthCalculator::class,
