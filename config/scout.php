...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Here you may configure your TNTSearch settings. TNTSearch is a local
    | SQLite / MySQL / PostgreSQL based search engine. The storage path is
    | required for index files to be written.
    |
    */
